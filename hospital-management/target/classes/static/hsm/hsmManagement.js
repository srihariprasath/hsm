...
hsmAssetAddApp.controller('hsmAssetAddController', function($scope,$http,$location,$rootScope) {
    $scope.addAsset=function()
    {
        ...
        $http({
            url: 'http://localhost:8080/hsm/secure/assetAdd',
            method: "POST",
            data: parameter,
            crossDomain:true,
            headers:{
...
hsmAssetSearchApp.controller('hsmAssetSearchController', function($scope,$http,$location,$rootScope,searchAstData) {
    ...
    {
			$http({
				url: 'http://localhost:8080/hsm/secure/assetSearch',
				method: "POST",
    ...
    {	
        ...
        alert("$rootScope.searchParameter::::"+$rootScope.searchAstParameter);
    }
})
...
hsmAstView.controller('hsmAstViewCntrl', function($scope,$http,$location,$rootScope,searchAstData) {
    ...
    { 
        ...
        $http({
            url: 'http://localhost:8080/hsm/secure/assetEdit',
            method: "POST",
            data: parameter,
            crossDomain:true,
            headers:{
    ...
    {  
        ...
        alert("Parameter:::"+parameter);
        $http({
            url: 'http://localhost:8080/hsm/secure/assetDelete',
            method: "POST",
            data: parameter,
            crossDomain:true,
            headers:{
...
hsmEmpAddApp.controller('hsmEmpAddController', function($scope,$http,$location,$rootScope,searchData) {
    ...
    $scope.addEmployee=function()
    {
        ...
        $http({
            url: 'http://localhost:8080/hsm/secure/employeeAdd',
            method: "POST",
            data: parameter,
            crossDomain:true,
            headers:{
...
hsmEmpSearchApp.controller('hsmEmpSearchController', function($scope,$http,$location,$rootScope,searchData) {
    ...
    {
			$http({
				url: 'http://localhost:8080/hsm/secure/employeesearch',
				method: "POST",
    ...
    $scope.searchEmployee=function()
    {
        ...
        alert("!!!!!!!!"+$scope.showEmpSearchResults);
    }
})
...
hsmEmpView.controller('hsmEmpViewCntrl', function($scope,$http,$location,$rootScope,searchData) {
    ...
    { 
        ...
        $http({
            url: 'http://localhost:8080/hsm/secure/employeeEdit',
            method: "POST",
            data: parameter,
            crossDomain:true,
            headers:{
    ...
    {  
        ...
        $http({
            url: 'http://localhost:8080/hsm/secure/employeeDelete1',
            method: "POST",
            data: parameter,
            crossDomain:true,
            headers:{
...
hsmInfoAddApp.controller('hsmInfoAddController', function($scope,$http,$location,$rootScope,searchData) {
    $scope.addInfoApp=function()
    {
        ...
        $http({
            url: 'http://localhost:8080/hsm/secure/infoAdd',
            method: "POST",
            data: parameter,
            crossDomain:true,
            headers:{
...
hsmInfoSearchApp.controller('hsmInfoSearchController', function($scope,$http,$location,$rootScope,searchInfoData) {
	 ...
	 $scope.searchInfoChild=function(data)
    {
			...
			$http({
				url: 'http://localhost:8080/hsm/secure/infoSearch',
				method: "POST",
...
hsmInfoView.controller('hsmInfoViewCntrl', function($scope,$http,$location,$rootScope,searchInfoData) {
    ...
    {  
            alert("$scope.empId:::"+$rootScope.editinfoDetails.empId);
            ...
            $http({
                url: 'http://localhost:8080/hsm/secure/infoEdit',
                method: "POST",
                data: parameter,
                crossDomain:true,
                headers:{
    ...
    {  
            ...
            alert("Parameter:::"+parameter);
            $http({
                url: 'http://localhost:8080/hsm/secure/infoDelete',
                method: "POST",
                data: parameter,
                crossDomain:true,
                headers:{
...
hsmAngularapp.controller('hsmLoginCntrl', function($scope,$http,$location,$rootScope) {
    $scope.submit=function()
    {
        ...
        alert("parameter::"+parameter);
        $http.post('http://localhost:8080/hsm/login',parameter).success(function(response){
            ...
            if(response.loginFailure=='N'){
                ...
                alert("$rootScope.admin:::"+$rootScope.admin);
